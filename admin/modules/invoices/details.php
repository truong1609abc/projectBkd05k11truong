...
<style type="text/css">
    ...
    table,tr,td,th{
        ...
        .invoice-details table,tr,td,th{
            border: 1px solid black;
            color: black;
        }
</style>
<div class="invoice-details">
        ...
        <h4>Tình trạng: 
            ...
            <?php 
                if ($status==0) {
                    echo "<a href='index.php?module=invoices&action=accep&id_invoice=$id_invoice'>Duyệt đơn hàng</a>";
                }
                else if($status==1){
                    echo "<a href='index.php?module=invoices&action=success&id_invoice=$id_invoice'>Thành công</a>";
                }
